...
fisher.test(table1)
```
According to the ifnerential data, I can conclude that there is actually no statistically significant difference in the data. The Fisher exact test can confirm this. Since 1 is in the confidence interval, then that means that there is no difference in the data.